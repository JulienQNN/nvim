...
--         local line3 = vim.filetype.getlines(bufnr, 7)
--         if
--           vim.filetype.matchregex(line1, [[^AWSTemplateFormatVersion]])
--           or vim.filetype.matchregex(line3, [[^AWSTemplateFormatVersion]])
--           or vim.filetype.matchregex(line3, [[AWS::Serverless-2016-10-31]])
