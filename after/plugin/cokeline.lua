...
local components = {
    ...
    left_half_circle = {
        text = "",
        fg = function(buffer)
            return buffer.is_focused and "#cba6f7" or get_hex("ColorColumn", "bg")
        end,
        bg = get_hex("Normal", "bg"),
        truncation = { priority = 1 },
    },
    ...
    devicon_or_pick_letter = {
        ...
        fg = function(buffer)
            return (mappings.is_picking_focus() and "#f9e2af")
                or (mappings.is_picking_close() and "#f38ba8")
    ...
    close_or_unsaved = {
        ...
        fg = function(buffer)
            return buffer.is_modified and "#45475a" or nil
        end,
